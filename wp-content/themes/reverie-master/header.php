        	...
        	<div class="navbar navbar_ clearfix">
            	<div class="container">
                    <div class="row">
                        <div class="span4">
                        	<div class="logo">
                        		<h1><a href="<?php echo get_settings('home'); ?>"><img src="http://dev.tisseur-de-toile.fr/mjm-web2/celine/portfolio/wp-content/uploads/2014/04/logo.png" ></a></h1>
                        ...
                        <div class="span8">
                        	<div class="follow_us">
                                <ul>
                                    ...
                                    <li><a href="#" class="delicious">LinkedIn</a></li>
                                </ul>
                            </div>
                            <div class="clear"></div>
                            <nav id="main_menu">
                                <div class="menu_wrap">
                                    <ul class="nav sf-menu">
                                      <li class="current"><a href="<?php echo get_settings('home'); ?>">Home</a></li>
                                      <li><a href="#about">About</a></li>
                                      <li class="sub-menu"><a href="#options">Portfolio</a>
                                      </li>                                  
